...
async function generateTree(inputId) {
...
document.addEventListener("DOMContentLoaded", function () {
  document.getElementById("btnSearchInfo").addEventListener("click", async function () {
    const inputId = document.getElementById("trackingId").ariaValueMax.trim();
    await generateTree(inputId);
  });
});